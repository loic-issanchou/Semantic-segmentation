...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    upsample_1 = tf.layers.conv2d_transpose(conv_1x1_layer7, num_classes, 4, 2, padding="same", kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))

    #tf.Print(upsample_1, [tf.shape(upsample_1)[1:3]])
    ...
    skip_1 = tf.add(upsample_1, conv_1x1_layer4)
    ...
    skip_2 = tf.add(upsample_2, conv_1x1_layer3)

    nn_last_layer = tf.layers.conv2d_transpose(skip_2, num_classes, 16, 8, padding="same", kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
